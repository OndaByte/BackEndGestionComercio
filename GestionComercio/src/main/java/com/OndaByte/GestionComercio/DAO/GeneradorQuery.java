 ...
 * @param <T>
 */
public abstract class GeneradorQuery <T> {
    ...
    public GeneradorQuery(){setCampos();}
    /**
     * Este metodo debe ser definido por las clases especificas que hereden de GeneradorQuery, deberia devolver el tipo del objeto asociado a la entidad de la bd.
     * @return T
     */
    abstract public Class<T> getClase();
    /**
     * Este metodo debe ser definido por las clases especificas que hereden de GeneradorQuery, deberia devolver el nombre del campo clave de la entidad.
     * @return String
     */
     ...
     */
    public String getQueryAlta()  throws Exception {
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GeneradorQuery.alta - SQL para inserción: " + query);
        }
    ...
    public String getQueryModificar()  throws Exception{
        ...
        if (logger.isDebugEnabled()) {
            logger.debug("GeneradorQuery.filtrar - SQL para Filtrar: " + query);
        }
     ...
     * @return List<T> - lista de todos los elementos asociados a ids
     */
    public String getQueryFiltrar(List<String> campos, List<String> valores, List<Integer> condiciones) throws Exception {
